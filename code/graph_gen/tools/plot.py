...
def ciplot(ax, t, mu, minus_sigma, plus_sigma, x_real, label, color=None):
    """
    ...
    ax.fill_between(t, -plus_sigma, plus_sigma, color=color, alpha=0.5, label = label)
    x_pred, = ax.plot(t, mu)
    # x_real, = ax.plot(t, x_real)
