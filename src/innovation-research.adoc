...
// ====
The roadmap on the scope of indoor positioning systems is almost finished. With this results, we have a landscape of existing technologies and products and we may desing a specific product.

For now we have a first draft of a business model. 

Innovation reseacrh:: a solution that provides a service to guide users inside of the building. This solution is primarily aimed at social events and commercials, such as exhibitions and expo centers. Also, some of the possible applications are stationary public indoor places, such as museums and Skoltech new campus.
...
//Goals:
//    publish open parts of a technological research
//    update the project and apply to grant program or other R&D/startup support program
//    identify strategy and complete the project
